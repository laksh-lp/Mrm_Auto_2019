...
def motorcode():
	...
	transmit.sendall(('m'+gear+'x'+x+'y'+y).encode())
...
#print h
TCP_IP = '192.168.1.7' # this IP of my pc. When I want raspberry pi 2`s as a client, I replace it with its IP '169.254.54.195'
TCP_PORT = 23
BUFFER_SIZE = 1024
